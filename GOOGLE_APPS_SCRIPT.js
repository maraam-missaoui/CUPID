// ============================================
// CUPID BOUTIQUE — GOOGLE APPS SCRIPT
...
// 2. Create a new project named "CUPID Orders"
...
function doGet(e) {
  return ContentService
    .createTextOutput('CUPID Boutique order endpoint is running ✓')
  ...
  const html = `
    <div style="font-family:Georgia,serif;max-width:600px;margin:0 auto;background:#fff">
      <div style="background:linear-gradient(135deg,#c97088,#c9a96e);padding:32px;text-align:center">
        <h1 style="color:white;margin:0;font-size:28px;letter-spacing:4px">CUPID</h1>
      ...
      <div style="background:#2a1a20;padding:20px;text-align:center">
        <p style="color:rgba(255,255,255,0.5);font-size:12px;margin:0">CUPID Boutique — Order Management System</p>
      </div>
    </div>
  `;
...
function sendCustomerEmail(data) {
  const subject = `Your CUPID order is confirmed! 🎀`;
    ...
    <div style="font-family:Georgia,serif;max-width:600px;margin:0 auto;background:#fff">
      ...
      <div style="padding:40px;text-align:center">
        ...
        <p style="color:#a07080;font-size:13px;margin-top:24px;line-height:1.6">
          ...
          Questions? DM us on Instagram @CUPIDboutique.tn 💌
        </p>
      </div>
      
      <div style="background:#2a1a20;padding:20px;text-align:center">
        <p style="color:rgba(255,255,255,0.5);font-size:12px;margin:0">© 2025 CUPID Boutique · Made with ♡ in Tunisia</p>
      </div>
    </div>
  `;
